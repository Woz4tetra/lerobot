...
export ROBOT_CAMERAS="{ \
  gripper: { \
    type: opencv, index_or_path: /dev/lerobot_gripper, width: 640, height: 480, fps: 31, backend: V4L2, \
    v4l2_controls: { \
  ...
  overhead: { \
    type: opencv, index_or_path: /dev/lerobot_overhead, width: 640, height: 480, fps: 30, fourcc: MJPG, backend: V4L2, \
    v4l2_controls: { \
